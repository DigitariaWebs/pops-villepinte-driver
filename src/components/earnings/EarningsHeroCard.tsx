  ...
  return (
    ...
    >
      ...
      <Text
        ...
        style={{ fontSize: 10, letterSpacing: 2, color: "rgba(255,255,255,0.6)" }}
      >
        {periodLabel}
      </Text>
      ...
      >
        ...
        <Stat
          ...
          value={
            deliveries === 0
              ? "—"
              : formatPriceEUR(amountEUR / deliveries)
          }
        />
      </View>
    </View>
...
function Stat({ label, value }: { label: string; value: string }): React.ReactElement {
  return (
    <View className="flex-1">
      <Text
        className="font-sans-bold uppercase"
        style={{ fontSize: 9, letterSpacing: 2, color: "rgba(255,255,255,0.5)" }}
      >
        {label}
      </Text>
      <Text
        className="font-sans-bold"
        style={{ fontSize: 18, color: colors.surface, marginTop: 4 }}
      >
        {value}
      </Text>
    </View>
